...
import { FileText, Users, DollarSign, CheckCircle, Clock, AlertCircle, LogIn, LogOut, Shield, User, Plus, Edit, Trash2 } from 'lucide-react'
    ...
    <div className="App">
      ...
      <main className="main-content">
        <div className="container">
          ...
          {/* Admin Panel */}
          {user.role === 'admin' && allClaims.length > 0 && (
            <div className="card">
            ...
            <div className="modal-overlay">
              <div className="modal-content">
                ...
                <div className="modal-body">
                  <form onSubmit={editingClaim ? updateClaim : createClaim}>
                    <div className="mb-4">
